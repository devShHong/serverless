...
const steps = {
  ...
  dashboardLogin: require('@serverless/enterprise-plugin/lib/cli/interactive-setup/dashboard-login'),
  dashboardSetOrg: require('@serverless/enterprise-plugin/lib/cli/interactive-setup/dashboard-set-org'),
